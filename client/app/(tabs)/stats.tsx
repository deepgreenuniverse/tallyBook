...
const styles = StyleSheet.create({
  ...
  modalBlur: { padding: 24 },
  modalTitle: { fontSize: 18, fontWeight: '700', color: '#FFF', textAlign: 'center', marginBottom: 20 },
  modalInput: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 12, paddingHorizontal: 14, marginBottom: 20 },
  modalCurrency: { fontSize: 20, color: 'rgba(255,255,255,0.5)', marginRight: 6 },
  modalInputField: { flex: 1, fontSize: 22, color: '#FFF', paddingVertical: 14 },
  modalBtns: { flexDirection: 'row', gap: 12 },
  modalCancel: { flex: 1, paddingVertical: 12, alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 10 },
  modalCancelText: { fontSize: 15, fontWeight: '600', color: 'rgba(255,255,255,0.7)' },
  modalConfirm: { flex: 1, borderRadius: 10, overflow: 'hidden' },
  modalConfirmGrad: { paddingVertical: 12, alignItems: 'center' },
